    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <Section className="py-16 sm:py-20 bg-gradient-to-b from-cream to-primary/5">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <a
            href={`https://wa.me/?text=${encodeURIComponent('Conheça o Choppinho Fit, seu companheiro de corrida conectado ao Strava e WhatsApp! ' + window.location.href)}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-[#25D366] text-white px-8 py-4 rounded-full font-display font-bold text-lg shadow-xl shadow-[#25D366]/25 hover:shadow-2xl transition-all hover:-translate-y-0.5"
          >
